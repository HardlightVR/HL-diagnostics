# HL-diagnostics
Source for a standalone application that allows for full featured debugging of the Hardlight suit and any other peripheral supported in the Engine. Provides live tracking, haptics, data and error visualization, as well as a terminal for directly sending serial instructions to the peripheral.
